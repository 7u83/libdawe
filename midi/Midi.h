...
{
typedef int tempoT;
//typedef long nmiditicks_T;
typedef unsigned char MidiByte;
#define MidiMinValue  (MidiByte)0
#define MidiMidValue  (MidiByte)64
#define MidiMaxValue  (MidiByte)127

typedef unsigned int TrackId;
const TrackId NoTrack = 0xDEADBEEF;
...
const MidiByte MIDI_CONTROLLER_EXPRESSION    = 0x0B;
